...
settIngContainer(
  ...
  return Container(
    ...
    decoration: BoxDecoration(
        color: SHContainerColor, borderRadius: BorderRadius.circular(16)),
    child: Row(
      children: [
...
Widget placeHolderWidget(
  ...
  //  Image.asset('images/dating/placeholder.jpg', height: height, width: width, fit: fit ?? BoxFit.cover, alignment: alignment ?? Alignment.center)
